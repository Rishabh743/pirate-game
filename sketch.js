...
function keyPressed() {
  ...
  cannonExplosion.setVolume(0.09)
  }
}
  ...
  if (boats.length > 0) {
    ...
    for (var i = 0; i < boats.length; i++) {
      ...
      if (collision.collided && !boats[i].isBroken) {
        isGameOver = true;
        if(!pirateLaughing&&!pirateLaugh.isPlaying()){
pirateLaugh.play()
        }
        gameOver();
      }
  ...
  swal(
    {
      ...
      imageUrl:
        "https://media.istockphoto.com/vectors/pirate-ship-cartoon-vector-id868289790?k=6&m=868289790&s=612x612&w=0&h=zxgayt0axM0PBlrABgywC0hsDx7P0SnJB-znWFvRFAM=",
      imageSize: "150x150",
